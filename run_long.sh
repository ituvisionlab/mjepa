...
cd $RUNDIR
python -m app.main_distributed --fname configs/pretrain_mae/vitb16_mae_mri_2mask.yaml --time 4300 --nodes 1  --folder /gpfs/home/unalg01/jepa --partition a100_long
