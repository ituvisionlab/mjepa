...
cd $RUNDIR
python -m app.main_distributed --fname configs/pretrain/exp/vitb16_mri_batchsize10.yaml --time 5700 --nodes 3 --folder /gpfs/home/unalg01/jepa --partition reservation --reservation sodicksonlab_reservation
