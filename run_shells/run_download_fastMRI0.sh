...
curl -C - "https://fastmri-dataset.s3.amazonaws.com/v4.0/fastMRI_breast_IDS_150_300_DCM.tar.gz?AWSAccessKeyId=AKIAJM2LEZ67Y2JL3KRA&Signature=cWeQlGsQDGunul83PJ1T8k%2F6a1k%3D&Expires=1745437976" --output "$OUTPUT_FILE"
