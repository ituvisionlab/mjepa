...
OUTPUT_FILE="SCAN_MRI_Download5.zip"
...
curl -C - "https://ida.loni.usc.edu/download/files/ida2/9c240e47-57d7-4c03-bcce-94f454321283/SCAN_ALL_MRI_0_dataset.zip" --output "$OUTPUT_FILE"
