...
cd $RUNDIR
python -m app.main_distributed --fname configs/pretrain/vitb16_mri_res_crop128.yaml --time 7200 --nodes 3 --folder /gpfs/home/unalg01/jepa --partition reservation --reservation unal_reservation
