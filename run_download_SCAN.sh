...
OUTPUT_FILE="SCAN_MRI_Download1.zip"
...
curl -C - "https://ida.loni.usc.edu/download/files/ida2/3b1d4ad8-7ba7-46f6-9457-72f52bb01cc3/SCAN_ALL_MRI_dataset.zip" --output "$OUTPUT_FILE"
