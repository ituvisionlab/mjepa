...
OUTPUT_FILE="SCAN_MRI_Download4.zip"
...
curl -C - "https://ida.loni.usc.edu/download/files/ida2/66302885-db01-444a-af8a-c040e438aebe/SCAN_ALL_MRI_0_dataset.zip" --output "$OUTPUT_FILE"
