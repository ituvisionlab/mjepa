...
parser.add_argument(
    '--reservation', type=str, default=None,
...
def launch_app_with_parsed_args(
    ...
    log_dir = get_new_log_dir(args_for_pretrain[0]['logging']['folder'], prefix=f'{args_for_pretrain[0]["tag"]}_pretrain_distributed_', postfix='')
