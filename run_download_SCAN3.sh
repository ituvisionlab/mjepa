...
OUTPUT_FILE="SCAN_MRI_Download3.zip"
...
curl -C - "https://ida.loni.usc.edu/download/files/ida2/6f943b6e-4d00-4d5b-a566-84a396bea228/SCAN_ALL_MRI_0_dataset.zip" --output "$OUTPUT_FILE"
