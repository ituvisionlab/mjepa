...
cd $RUNDIR
python -m evals.main_distributed --fname configs/evals/vitb16_mri_eval.yaml --time 4300 --nodes 2 --folder /gpfs/home/unalg01/jepa --partition reservation --reservation unal_reservation
