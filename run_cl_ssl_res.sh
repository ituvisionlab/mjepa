...
cd $RUNDIR
python -m evals.main_distributed --fname configs/evals/vitb16_mri_eval.yaml --folder /gpfs/home/unalg01/jepa --partition reservation --reservation sodicksonlab_reservation
