...
cd $RUNDIR
python -m evals.main_distributed --fname configs/evals/vitl16_mri_eval.yaml --time 4300 --nodes 3 --folder /gpfs/home/unalg01/jepa --partition reservation --reservation unal_reservation
