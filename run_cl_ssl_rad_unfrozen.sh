...
cd $RUNDIR
python -m evals.main_distributed --fname configs/evals/vitb16_mnist_eval_unfrozen.yaml --time 4300 --nodes 1  --folder /gpfs/home/unalg01/jepa --partition radiology
