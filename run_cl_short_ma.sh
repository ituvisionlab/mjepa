...
cd $RUNDIR
python -m evals.main_distributed --fname configs/evals/vitb16_mri_eval_mae_frozen.yaml --time 4300 --nodes 1  --folder /gpfs/home/unalg01/jepa --partition a100_short
