...
#curl -C - "https://fastmri-dataset.s3.amazonaws.com/v4.0/fastMRI_breast_IDS_001_150_DCM.tar.gz?AWSAccessKeyId=AKIAJM2LEZ67Y2JL3KRA&Signature=skgIoO6PDGTM1iwZibmFok1%2Fjww%3D&Expires=1745437976" --output "$OUTPUT_FILE"
#curl -C - "https://fastmri-dataset.s3.amazonaws.com/v2.0/knee_DICOMs_batch1.tar.xz?AWSAccessKeyId=AKIAJM2LEZ67Y2JL3KRA&Signature=%2BfQxtPIAmapx9L%2B9EiRqd0CT0R8%3D&Expires=1745437976" --output "$OUTPUT_FILE"
curl -C - "https://fastmri-dataset.s3.amazonaws.com/v2.0/knee_DICOMs_batch2.tar.xz?AWSAccessKeyId=AKIAJM2LEZ67Y2JL3KRA&Signature=ONLikyBGI2DtBFNST9q6EcFys8M%3D&Expires=1745437976" --output "$OUTPUT_FILE"
