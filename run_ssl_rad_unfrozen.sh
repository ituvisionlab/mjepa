...
cd $RUNDIR
python -m app.main_distributed --fname configs/pretrain/vitb16_mri_eval_unfrozen.yaml --time 4300 --nodes 1  --folder /gpfs/home/unalg01/jepa --partition radiology
